...
<h6 align="center">안녕하세요 신입 프론트엔드 개발자 김민서 입니다.
저는 React,Redux,TypeScript,TailwindCss 등 프론트엔드에서 주로 다루는 기술 뿐만 아니라 NodeJs,MongoDB등의 백엔드 기술을 이용한 팀 프로젝트 경험도 있습니다. 또한 NextJs를 익혀 저만의 포트폴리오를 만들며, 저의 개발 실력을 향상시키려 노력하였습니다.
